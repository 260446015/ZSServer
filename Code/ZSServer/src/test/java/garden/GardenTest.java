...
//		System.out.println(targetInfo.toJSONString());
	...
	public void testKeyWords(){
		OpeneyesDTO dto = new OpeneyesDTO();
		dto.setSpec(KeyConstan.URL.GUANJIANZI);
		dto.setWord("人工智能");
		JSONObject targetInfo = openeyesService.getKeyWords(dto);
		System.out.println(targetInfo.toJSONString());
	}
	@Test
