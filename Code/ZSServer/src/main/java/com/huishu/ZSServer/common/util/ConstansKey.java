...
//	 public static final String IP_PORT = "http://localhost:8093/" ;
	...
	/**
	 * 存储【web版】搜索接口url
	 * https://open.api.tianyancha.com/services/v3/newopen/searchV2.json?word=
	 * 北京百度网讯科技有限公司 天眼查接口ID 159
	 */
	public static final String SEARCHV2 = "https://open.api.tianyancha.com/services/v3/newopen/searchV2.json";
	/**
	 * 存储【web版】获取企业基本信息url
	 * https://open.api.tianyancha.com/services/v3/newopen/baseinfo.json?id=
	 * 22822 天眼查接口ID 98
	 */
	 ...
	 * https://open.api.tianyancha.com/services/v3/newopen/baseinfoV2.json?id=
	 * 22822 天眼查接口ID 99
	 */
	 ...
	 * https://open.api.tianyancha.com/services/v3/newopen/baseinfoV3.json?id=
	 * 22822 天眼查接口ID 100
	 */
	...
	/**
	 * 存储【web版】变更记录url
	 * https://open.api.tianyancha.com/services/v3/newopen/changeinfo.json?id=
	 * 22822 天眼查接口ID 104
	 */
	...
	/**
	 * 存储【web版】股票行情url
	 * https://open.api.tianyancha.com/services/v3/newopen/volatility.json?id=
	 * 199557844 天眼查接口ID 134
	 */
	public static final String VOLATILITY = "https://open.api.tianyancha.com/services/v3/newopen/volatility.json";
	/**
	 * 存储【web版】企业简介（股票）url
	 * https://open.api.tianyancha.com/services/v3/newopen/companyInfo.json?id=
	 * 485568977 天眼查接口ID 135
	 */
	public static final String COMPANYINFO = "https://open.api.tianyancha.com/services/v3/newopen/companyInfo.json";
	/**
	 * 存储【web版】高管信息（股票）url
	 * https://open.api.tianyancha.com/services/v3/newopen/seniorExecutive.json?
	 * id=485568977&pageNum=1&pageSize=10 天眼查接口ID 136
	 */
	public static final String SENIOREXECUTIVE = "https://open.api.tianyancha.com/services/v3/newopen/seniorExecutive.json";
	/**
	 * 存储【web版】参股控股（股票）url
	 * https://open.api.tianyancha.com/services/v3/newopen/holdingCompany.json?
	 * id=485568977&pageNum=1&pageSize=10 天眼查接口ID 137
	 */
	public static final String HOLDINGCOMPANY = "https://open.api.tianyancha.com/services/v3/newopen/holdingCompany.json";
	/**
	 * 存储【web版】上市公告（股票）url
	 * https://open.api.tianyancha.com/services/v3/newopen/announcement.json?id=
	 * 485568977&pageNum=1&pageSize=10 天眼查接口ID 138
	 */
	 ...
	 * https://open.api.tianyancha.com/services/v3/open/detail.json?name=
	 * 中科软科技股份有限公司 天眼查接口ID 18
	 */
	...
	/**
	 * 存储公司详情,（根据id）url
	 * 正常:https://open.api.tianyancha.com/services/v3/open/w/companydetail.json?
	 * id=22822
	 * 带经营异常：https://open.api.tianyancha.com/services/v3/open/w/companydetail.
	 * json?id=1073117874
	 * 带分支机构：https://open.api.tianyancha.com/services/v3/open/w/companydetail.
	 * json?id=376321715 天眼查接口ID 40
	 */
	public static final String COMPANYDETAIL = "https://open.api.tianyancha.com/services/v3/open/w/companydetail.json";
	/**
	 * 存储公司详情,根据公司名称获得url
	 * 正常:https://open.api.tianyancha.com/services/v3/open/w/detail.json?name=
	 * 北京百度网讯科技有限公司
	 * 带经营异常：https://open.api.tianyancha.com/services/v3/open/w/detail.json?name
	 * =湖南瑞源生物医药科技有限公司
	 * 带分支机构：https://open.api.tianyancha.com/services/v3/open/w/detail.json?name
	 * =重庆金夫人实业有限公司 天眼查接口ID 41
	 */
	...
	/**
	 * 存储获取公司所有商标信息url
	 * https://open.api.tianyancha.com/services/v3/open/allTm?id=22822 天眼查接口ID
	 * 36
	 */
	public static final String ALLTM = "https://open.api.tianyancha.com/services/v3/open/allTm";
	/**
	 * 存储获取公司专利信息url
	 * https://open.api.tianyancha.com/services/v3/open/patents?name=
	 * 北京百度网讯科技有限公司&pageNum=1 天眼查接口ID 43
	 */
	public static final String OPENPATENTS = "https://open.api.tianyancha.com/services/v3/open/patents";
	/**
	 * 存储获取公司所有专利信息url
	 * https://open.api.tianyancha.com/services/v3/open/allPatents?name=
	 * 北京百度网讯科技有限公司 天眼查接口ID 44
	 */
	public static final String ALLPATENTS = "https://open.api.tianyancha.com/services/v3/open/allPatents";
	/**
	 * 存储获取公司招投标信息url
	 * https://open.api.tianyancha.com/services/v3/open/bids?name=北京百度网讯科技有限公司&
	 * pageNum=1 天眼查接口ID 45
	 */
	public static final String OPENBIDS = "https://open.api.tianyancha.com/services/v3/open/bids";
	/**
	 * 存储获取公司著作权信息url
	 * https://open.api.tianyancha.com/services/v3/open/copyrights?name=
	 * 北京百度网讯科技有限公司&pageNum=1 天眼查接口ID 46
	 */
	public static final String COPYRIGHTS = "https://open.api.tianyancha.com/services/v3/open/copyrights";
	/**
	 * 存储获取公司所有著作权信息url
	 * https://open.api.tianyancha.com/services/v3/open/allCopyrights?name=
	 * 北京百度网讯科技有限公司 天眼查接口ID 47
	 */
	public static final String ALLCOPYRIGHTS = "https://open.api.tianyancha.com/services/v3/open/allCopyrights";
	/**
	 * 存储获取公司招聘信息url
	 * https://open.api.tianyancha.com/services/v3/open/employments?name=
	 * 北京百度网讯科技有限公司&pageNum=1 天眼查接口ID 42
	 */
	public static final String OPENEMPLOYMENTS = "https://open.api.tianyancha.com/services/v3/open/employments";
	/**
	 * 存储获取公司失信信息url
	 * https://open.api.tianyancha.com/services/v3/open/dishonest?name=
	 * 天津信裕房地产发展有限公司&pageNum=1 天眼查接口ID 49
	 */
	public static final String OPENDISHONEST = "https://open.api.tianyancha.com/services/v3/open/dishonest";
	/**
	 * 存储获取公司债券信息url
	 * https://open.api.tianyancha.com/services/v3/open/bonds?name=中国人民银行&
	 * pageNum=1 天眼查接口ID 50
	 */
	public static final String BONDS = "https://open.api.tianyancha.com/services/v3/open/bonds";
	/**
	 * 存储获取公司备案信息url
	 * https://open.api.tianyancha.com/services/v3/open/icp?id=22822 天眼查接口ID 32
	 */
	public static final String OPENICP = "https://open.api.tianyancha.com/services/v3/open/icp";
	/**
	 * 存储获取公司诉讼信息url
	 * https://open.api.tianyancha.com/services/v3/open/lawsuit?name=
	 * 北京百度网讯科技有限公司&pageNum=1 天眼查接口ID 28
	 */
	public static final String OPENLAWSUIT = "https://open.api.tianyancha.com/services/v3/open/lawsuit";
	/**
	 * 存储获取诉讼详情通过uuidurl
	 * https://open.api.tianyancha.com/services/v3/open/lawsuit/detail?id=
	 * d4e220698a6c4e178bad5a0913f69dc6 天眼查接口ID 29
	 */
	 ...
	 * https://open.api.tianyancha.com/services/v3/open/changeInfo?name=
	 * 北京百度网讯科技有限公司 天眼查接口ID 31
	 */
	public static final String OPENCHANGEINFO = "https://open.api.tianyancha.com/services/v3/open/changeinfo";
	/**
	 * 存储获取公司新闻信息url
	 * https://open.api.tianyancha.com/services/v3/open/news.json?name=
	 * 北京百度网讯科技有限公司 天眼查接口ID 34
	 */
	public static final String NEWS = "https://open.api.tianyancha.com/services/v3/open/news.json";
	/**
	 * 存储获取公司严重违法信息url
	 * https://open.api.tianyancha.com/services/v3/open/Illegal.json?name=
	 * 陕西华庭酒店有限公司&pageNum=1 天眼查接口ID 48
	 */
	public static final String ILLEGAL = "https://open.api.tianyancha.com/services/v3/open/Illegal.json";
	/**
	 * 存储获取公司股权出质信息url
	 * https://open.api.tianyancha.com/services/v3/open/companyEquity.json?name=
	 * 北京逸璟物业管理有限公司 天眼查接口ID 56
	 */
	public static final String COMPANYEQUITY = "https://open.api.tianyancha.com/services/v3/open/companyEquity.json";
	/**
	 * 存储获取公司行政处罚信息url
	 * https://open.api.tianyancha.com/services/v3/open/punishment.json?name=
	 * 北京逸璟物业管理有限公司 天眼查接口ID 58
	 */
	public static final String PUNISHMENT = "https://open.api.tianyancha.com/services/v3/open/punishment.json";
	/**
	 * 存储获取公司检查抽查信息url
	 * https://open.api.tianyancha.com/services/v3/open/checkInfoList.json?name=
	 * 博乐市婷芳农资服务部 天眼查接口ID 59
	 */
	public static final String CHECKINFOLIST = "https://open.api.tianyancha.com/services/v3/open/checkInfoList.json";
	/**
	 * 存储获取公司动产抵押信息url
	 * https://open.api.tianyancha.com/services/v3/open/companyMortgage.json?
	 * name=讷河市丰盛现代农业农机专业合作社 天眼查接口ID 57
	 */
	public static final String COMPANYMORTGAGE = "https://open.api.tianyancha.com/services/v3/open/companyMortgage.json";
	/**
	 * 存储获取公司关联发现信息url
	 * https://open.api.tianyancha.com/services/v3/open/oneKey/c.json?id=
	 * 948954637 天眼查接口ID 54
	 */
	public static final String ONEKEY_C = "https://open.api.tianyancha.com/services/v3/open/oneKey/c.json";
	/**
	 * 存储获取公司经营异常信息url
	 * https://open.api.tianyancha.com/services/v3/open/abnormalInfo.json?name=
	 * 湖南瑞源生物医药科技有限公司 天眼查接口ID 63
	 */
	...
	/**
	 * 存储获取基本信息url
	 * https://open.api.tianyancha.com/services/v3/open/edt.json?companyName=
	 * 北京百度网讯科技有限公司 天眼查接口ID 38
	 */
	...
	/**
	 * 存储获取简单的公司信息url
	 * https://open.api.tianyancha.com/services/v3/open/suggestDetailByName.json
	 * ?name=北京百度网讯科技有限公司 天眼查接口ID 53
	 */
