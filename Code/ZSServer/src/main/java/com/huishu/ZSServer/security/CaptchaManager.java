...
import com.huishu.ZSServer.common.util.send.SMSSender;
...
public class CaptchaManager {
	...
	private static final String MESSAGE = "【慧数科技】您的短信验证码为 %s, 请在30分钟内填写";
	private static final String ACCOUNTMESSAGE = "您的账号已通过审核，账号为 %s, 密码默认为123456，为保障账号安全请尽快修改密码";
