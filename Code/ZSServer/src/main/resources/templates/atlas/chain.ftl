                ...
                <div class="bigbox">
                    <div class="content-show fl">
                      ...
                      <div class="content-text fr">
                        <ol class="content-list fr ols mark-box">
                            <li class="active">
                                <a class="mark-item" href="javascript:void(0);">感知层</a>
                            </li>
                            <li class="active">
                                <a class="mark-item" href="javascript:void(0);">网络层</a>
                                
                            </li>
                            <li class="active">
                                <a class="mark-item" href="javascript:void(0);">执行层</a>
                               
                            </li>
                            <li class="active">
                                <a class="mark-item" href="javascript:void(0);">应用层</a>
