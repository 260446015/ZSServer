...
function addRegister(){
	...
	var param ={realName:_name,telphone:_phone,userEmail:_email,
			userJob:_position,userDepartment:_units,userPark:_garden,
			area:_address,userComp:_develop,captcha:_captcha};
	//判断用户输入的信息是否正确
	if(isEmpty(_name)){
		$('#name').focus();
