...
public interface BusinessRepository extends ElasticsearchRepository<AITInfo, String> {
	 ...
	 * @return
	 */
	public Page<AITInfo> findByParkAndEmotionAndBusinessAndDimension(String park, String emotion, String business,
			String dimension, Pageable pageable);
	 ...
	 * @return
	 */
	public Page<AITInfo> findByParkAndEmotionAndDimension(String park, String emotion, String dimension,
			Pageable pageable);
