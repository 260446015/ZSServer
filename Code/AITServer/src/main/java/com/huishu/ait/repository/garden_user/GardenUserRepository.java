...
@Transactional
public interface GardenUserRepository
		extends CrudRepository<GardenUser, Integer>, JpaSpecificationExecutor<GardenUser> {
	 ...
	 * @return
	 */
	Page<GardenUser> findByUserIdAndAreaAndIndustryType(Integer userId, String area, String industryType,
			Pageable pageable);
