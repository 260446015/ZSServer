			...
			<div class="userbox">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<div class="profile-info">
								...
								<span class="role"><i class="fa fa-circle bk-fg-success"></i>张三</span>
							</div>			
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a href="#"><i class="fa fa-wrench"></i>修改个人信息</a>
								</li>
								<li>
									<a href="page-invoice"><i class="fa fa-usd"></i> 账户金额</a>
								</li>
								<li>
									<a href="#"><i class="fa fa-file"></i> 查看个人信息</a>
								</li>
								<li>
