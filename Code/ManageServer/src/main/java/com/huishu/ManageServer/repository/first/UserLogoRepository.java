...
public interface UserLogoRepository extends CrudRepository<UserLogo, Long> {
	...
	@Query(value="select b.id,b.user_account,b.real_name,b.telphone,b.user_email,l.login_time,l.operation_time,l.search_company,l.search_count from t_user_logo l LEFT JOIN t_user_base b on l.user_id = b.id where logo_type = ?1 limit ?2,?3",nativeQuery=true)
