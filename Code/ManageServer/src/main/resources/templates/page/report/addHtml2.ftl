                        ...
                        <div class="panel-body">
                            <form action="javascript:void(0)" method="post" class="form-horizontal ">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="userAccount" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="panel-body" id="my_body">
                                    <div id="div1">
                                        <p> demo（常规）</p>
                                    </div>
                                </div>
                                <div class="bk-margin-bottom-10">
                                    <button class="btn btn-info my_add">添加模板数据 <i class="fa fa-plus"></i></button>
                                </div>
                            </form>
                            <p>
